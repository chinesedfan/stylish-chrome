...
window.addEventListener("message", function (event) {
    // send message into the extension
    chrome.runtime.sendMessage(event.data); // this event will be caught in the upper function on in the background script listener
});
